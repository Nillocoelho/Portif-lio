  ...
  projects: [
    {
      ...
      description:
        "API REST para controle financeiro pessoal, desenvolvida com Java e Spring Boot, com autenticação, cadastro de usuários, controle de receitas e despesas, categorização, filtros por período, documentação Swagger e persistência em PostgreSQL.",
      highlights: [
